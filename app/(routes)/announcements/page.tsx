...
export default function App() {
	...
	const renderCell = React.useCallback(
		(user: IAnnouncement, columnKey: React.Key) => {
					...
					return (
						<div className='relative flex justify-end items-center gap-2'>
							<Dropdown>
								...
								<DropdownMenu>
									<DropdownItem onClick={() => isOpenView(user)}>
										View
									</DropdownItem>
									<DropdownItem onClick={() => isOpenEdit(user)}>
										Edit
									</DropdownItem>
									<DropdownItem onClick={() => getIdAnnouncements(user.name)}>
										Delete
									</DropdownItem>
								</DropdownMenu>
							</Dropdown>
	...
	return (
		<>
			...
			<div
				className={
					view
						? 'transition-transform translate-y-[0%] w-full h-[100vh]  bg-white shadow-2xl fixed top-0 left-0 z-[99999]'
			...
			{deleteUser ? (
				<AnnouncementDelete
					deleteAnnouncement={setDeleteUser}
					announcementName={getName}
				/>
			) : (
				''
			)}
